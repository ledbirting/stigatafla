...
window.STIGATAFLA_CONFIG = {
  ...
  /** KR borðskil myndir/myndbönd — vistað í gegnum stillingar (splash-kr.json). */
  splashKrUrl:
    "https://media.zapp.is/storage/v1/object/public/stigatafla/stigatafla/splash-kr.json",
};
