...
(function (global) {
  ...
  var ROSTERS = {
    ...
    keflavik: [
      { id: "kef-1", name: "Ásgeir Orri Magnússon", number: 1, isStaff: false, introUrl: "", goalUrl: "" },
      { id: "kef-3", name: "Axel Ingi Jóhannesson", number: 3, isStaff: false, introUrl: "", goalUrl: "" },
      { id: "kef-4", name: "Nacho Heras", number: 4, isStaff: false, introUrl: "", goalUrl: "" },
      { id: "kef-5", name: "Davíð Helgi Aronsson", number: 5, isStaff: false, introUrl: "", goalUrl: "" },
      { id: "kef-6", name: "Sindri Snær Magnússon", number: 6, isStaff: false, introUrl: "", goalUrl: "" },
      { id: "kef-7", name: "Dagur Ingi Valsson", number: 7, isStaff: false, introUrl: "", goalUrl: "" },
      { id: "kef-8", name: "Breki Baxter", number: 8, isStaff: false, introUrl: "", goalUrl: "" },
      { id: "kef-9", name: "Halid Alghoul", number: 9, isStaff: false, introUrl: "", goalUrl: "" },
      { id: "kef-10", name: "Stefan Ljubicic", number: 10, isStaff: false, introUrl: "", goalUrl: "" },
      { id: "kef-11", name: "Muhamed Alghoul", number: 11, isStaff: false, introUrl: "", goalUrl: "" },
      { id: "kef-13", name: "Anton Kralj", number: 13, isStaff: false, introUrl: "", goalUrl: "" },
      { id: "kef-14", name: "Marin Mudrazija", number: 14, isStaff: false, introUrl: "", goalUrl: "" },
      { id: "kef-15", name: "Arnór Atli Aðalbjörnsson", number: 15, isStaff: false, introUrl: "", goalUrl: "" },
      { id: "kef-16", name: "Guðjón Pétur Stefánsson", number: 16, isStaff: false, introUrl: "", goalUrl: "" },
      { id: "kef-17", name: "Baldur Logi Guðlaugsson", number: 17, isStaff: false, introUrl: "", goalUrl: "" },
      { id: "kef-18", name: "Ernir Bjarnason", number: 18, isStaff: false, introUrl: "", goalUrl: "" },
      { id: "kef-19", name: "Edon Osmani", number: 19, isStaff: false, introUrl: "", goalUrl: "" },
      { id: "kef-20", name: "Marin Brigić", number: 20, isStaff: false, introUrl: "", goalUrl: "" },
      { id: "kef-21", name: "Alpha Conteh", number: 21, isStaff: false, introUrl: "", goalUrl: "" },
      { id: "kef-22", name: "Ásgeir Páll Magnússon", number: 22, isStaff: false, introUrl: "", goalUrl: "" },
      { id: "kef-23", name: "Eiður Orri Ragnarsson", number: 23, isStaff: false, introUrl: "", goalUrl: "" },
      { id: "kef-25", name: "Frans Elvarsson", number: 25, isStaff: false, introUrl: "", goalUrl: "" },
      { id: "kef-26", name: "Jóhann Elí Kristjánsson", number: 26, isStaff: false, introUrl: "", goalUrl: "" },
      { id: "kef-27", name: "Viktor Elmar Gautason", number: 27, isStaff: false, introUrl: "", goalUrl: "" },
      { id: "kef-28", name: "Viktor Árni Traustason", number: 28, isStaff: false, introUrl: "", goalUrl: "" },
      { id: "kef-30", name: "Mirsad Basic", number: 30, isStaff: false, introUrl: "", goalUrl: "" },
      { id: "kef-42", name: "Baldur Logi Brynjarsson", number: 42, isStaff: false, introUrl: "", goalUrl: "" },
      { id: "kef-47", name: "Egill Valur Karlsson", number: 47, isStaff: false, introUrl: "", goalUrl: "" },
      { id: "kef-77", name: "Mihajlo Rajakovac", number: 77, isStaff: false, introUrl: "", goalUrl: "" },
      { id: "kef-97", name: "Rúnar Leó Hólmarsson", number: 97, isStaff: false, introUrl: "", goalUrl: "" },
    ],
  };
