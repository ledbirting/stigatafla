...
(function (global) {
  ...
  global.STIGATAFLA_LEAGUE_TEAMS = [
    { id: "afturelding", name: "Afturelding", badgeUrl: B + "Afturelding.png" },
    { id: "breidablik", name: "Breiðablik", badgeUrl: B + "Breidablik.png" },
    { id: "fh", name: "FH", badgeUrl: B + "FH.png" },
    ...
    { id: "grotta", name: "Grótta", badgeUrl: B + "Grotta.png" },
    { id: "haukar", name: "Haukar", badgeUrl: B + "Haukar.png" },
    { id: "hk", name: "HK", badgeUrl: B + "HK.png" },
    { id: "ia", name: "ÍA", badgeUrl: B + "IA.png" },
